...
# prepare folders
mkdir data
torch ./FS_utils/__init__.py
mkdir ./FS_utils
mkdir -p ./FS_utils/waveglow/pretrained_model
...
mv waveglow_256channels_ljs_v2.pt ./FS_utils/aveglow/pretrained_model/waveglow_256channels.pt
